    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserCard", x => new { x.ApplicationUserId, x.CardId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserCard_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationUserCard_Cards_CardId",
                        column: x => x.CardId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserModel", x => new { x.ApplicationUsersId, x.ModelsId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserModel_AspNetUsers_ApplicationUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Desccription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserCard_CardId",
                table: "ApplicationUserCard",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserModel_ModelsId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ApplicationUserModel_Models_ModelsId",
                table: "ApplicationUserModel",
                column: "ModelsId",
